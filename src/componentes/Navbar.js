            ...
            <div class="container-md">
                ...
                <div class="collapse navbar-collapse" id="menu">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link active " aria-current="page" href="#" onClick={() => (window.location.href = "/Menu")}>Inicio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="#">Ensayo</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav  ">    
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item " href="#">{cookies.get('username')}</a></li>
